...
{
    Observer * observer = [[Observer alloc] initWithObject:self keyPath:keyPath options:options callback:callback];
    return observer;
}
...
{
    Observer * observer = [[Observer alloc] initWithObject:self keyPath:keyPath options:options target:target selector:selector];
    return observer;
}
